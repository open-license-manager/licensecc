...
A comprehensive [list of features](https://open-license-manager.github.io/licensecc/latest/analysis/features.html), and their status is available in the project site. 

If you're experiencing problems, or you need information you can't find in the **[documentation](https://open-license-manager.github.io/licensecc/latest/index.html)** please contact us on [github discussions](https://github.com/open-license-manager/licensecc/discussions).
...
- You need commercial support or guaranteed response times — see [maintenance status](https://open-license-manager.github.io/licensecc/latest/other/maintenance.html)
...
* Read the [quickstart](https://open-license-manager.github.io/licensecc/latest/usage/quickstart.html) and [concepts](https://open-license-manager.github.io/licensecc/latest/usage/concepts.html) sections in the documentation. This is the fastest way to get acquainted with the project.
...
For a complete list of dependencies and supported environments see [the project website](https://open-license-manager.github.io/licensecc/latest/development/Dependencies.html)
