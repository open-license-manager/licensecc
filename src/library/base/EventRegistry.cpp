...
EventRegistry::EventRegistry() {
	...
	currentLicenseId = LIC_ID_NOT_DEFINED;
}
...
void EventRegistry::addEvent(LCC_EVENT_TYPE event, const std::string& info) {
	addEvent(event, currentLicenseId.c_str(), info.c_str());
}

void EventRegistry::setCurrentLicenseId(const std::string& licenseLocationId) { currentLicenseId = licenseLocationId; }
